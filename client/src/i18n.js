        ...
        resources: {
            he: {
                translation: {
                    ...
                    'about.cards.mini.security.desc': 'הגנה מלאה על מידע אישי והצבעות המשתמשים.',

                    'about.cards.mini.support.title': 'תמיכה זמינה',
                    'about.cards.mini.support.desc': 'צוות מקצועי זמין בכל עת לעזרה ולפתרון בעיות.',
                    ...
                    'groups.list.card.pendingHint': 'בקשתך נשלחה וממתינה לאישור מנהל/ת',
                    ...
                    'join.hints.alreadyPending': 'כבר קיימת בקשת הצטרפות ממתינה לאישור.',
                    'join.hints.alreadyMember': 'את/ה כבר חבר/ה בקבוצה.',
                    'join.hints.groupOpen': 'הקבוצה פתוחה — אין צורך בבקשת הצטרפות.',

                    'join.loginModal.title': 'בקשת הצטרפות לקבוצה {{groupName, default:(קבוצה נעולה)}}',
                    ...
                    about: {
                        hero: {
                            ...
                            subtitle:
                                'פלטפורמה מקיפה לניהול בחירות אונליין - מנציגות כיתה ועד ועדי עובדים. כל מה שצריך למען תהליך בחירות שקוף, מאובטח ודמוקרטי.',
            ...
            en: {
                translation: {
                    ...
                    'about.cards.mini.security.desc': 'Full protection of personal data and user votes.',
                    ...
                    'groups.create.errors.candidateEndDateRequired': 'Candidate application end date is required',
                    'groups.create.errors.candidateAfterGroup':
                    ...
                    'groups.list.toasts.loginToCreate': 'You must log in before creating a group.',
                    'groups.list.toasts.loginToRequestJoin':
                    ...
                    'join.hints.alreadyPending': 'A join request already exists and is pending approval.',
                    'join.hints.alreadyMember': 'You are already a member of this group.',
                    'join.hints.groupOpen': 'This group is open — no join request is required.',
                    'join.loginModal.title': 'Join request for group {{groupName, default:(locked group)}}',
                    'join.loginModal.text': 'To request to join a locked group, you must be logged in.',
                    ...
                    'auth.forgot.genericSuccess': 'If this email exists, reset instructions have been sent.',
                    ...
                    'guide.highlightDesc':
                        'To get the most out of the system, review your group settings, manage members properly, and stay updated with real-time notifications.',
                    ...
                    'candidates.validation.descriptionTooLong':
                    ...
                    candidateApply: {
                        ...
                        status: {
                            ...
                            approved:
                                '✅ Your candidate request was approved. You are already a candidate in this group.',
                            rejected:
                                '⚠️ Your candidate request was rejected – you may submit a new request.',
                            removed:
                                '⚠️ Your previous candidacy was removed by the admin – you may submit a new request.',
                        },
                    ...
                    groups: {
                        list: {
                            tour: {
                                ...
                                cardBadges: "Badges show statuses like locked groups or open candidate submissions",
                                cardDesc: "This is a short description of the group",
                                cardOwner: "This shows who manages the group",
                                cardFooter: "This shows the end date (or that the group has expired)",
                        ...
                        detail: {
                            ...
                            locked: {
                                title: "Locked group",
                                mustLogin:
                                    'This group is locked. To request to join, please log in and send a join request from the "Groups" page.',
                                notMember:
                            ...
                            survey: {
                                ...
                                note:
                                    "Poll data is based on campaign support. Only candidates with an active campaign can receive support.",
                    ...
                    about: {
                        hero: {
                            ...
                            subtitle:
                                "A comprehensive platform for managing online elections - from class representatives to employee committees. Everything you need for a transparent, secure, and democratic election process.",
                        ...
                        features: {
                            ...
                            democratic: {
                                ...
                                desc:
                                    "Everyone can vote for whoever they want, with complete confidentiality. Results are displayed only after the election ends to prevent influencing voters.",
                            },
                            privacy: {
                                title: "Complete Privacy",
                                desc:
                                    "No one knows who voted for whom. Vote counts aren't displayed during the election, only at the end - to maintain fairness and prevent persuasion.",
                            },
                            campaigns: {
                                title: "Digital Campaigns",
                                desc:
                                    "Each candidate can create their own campaign, upload content, persuade, and present themselves in the best way possible.",
                            },
                            secure: {
                                title: "Secure & Reliable",
                                desc:
                                    "A secure and reliable system that ensures every vote counts and results are genuine. Option to define multiple winner positions (first, second, third, etc.).",
                            },
                            green: {
                                title: "Environmentally Friendly",
                                desc:
                                    "Online elections mean less paper, fewer printouts, and less waste. A small but important contribution to our green environment.",
                            },
                        },
                        useCases: {
                            ...
                            student: {
                                ...
                                desc:
                                    "Class representatives, student council, or any school elections - in a simple and fun way.",
                            },
                            workplace: {
                                title: "Employee Committees",
                                desc:
                                    "Elections for employee committees, employee representatives, or any organizational role - professionally and securely.",
                            },
                            community: {
                                title: "Communities & Organizations",
                                desc:
                                    "Building committees, volunteer organizations, social groups - any community can manage democratic elections.",
                            },
                            organization: {
                                title: "Any Type of Election",
                                desc:
                                    "From serious elections to small private ones - our platform fits everyone.",
                            },
                        },
                        cta: {
                            title: "Ready to Start?",
                            desc:
                                "Join us and turn your next elections into a digital, democratic, and professional experience.",
